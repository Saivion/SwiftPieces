...
export const categories = {
  text: { slug: "text", title: "Text", folder: "Text", description: "Type that reveals, breathes and renders as glass." },
  backgrounds: { slug: "backgrounds", title: "Backgrounds", folder: "Backgrounds", description: "Quiet atmospheres: shaders, meshes and touch-reactive fields." },
  ...
  navigation: { slug: "navigation", title: "Navigation", folder: "Navigation", description: "Docks, tracking tabs, stretch headers and receding drawers." },
