...
{/* GENERATED FILE. Edit registry/swift/controls/TimerDial.swift or TimerDial.mdx instead. */}
...
```swift
TimerDialExample().preferredColorScheme(.light)
```
...
<Tabs items={["TimerDial.swift"]}>
<Tab value="TimerDial.swift">

```swift title="TimerDial.swift"
import SwiftUI
