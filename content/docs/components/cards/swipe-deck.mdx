...
{/* GENERATED FILE. Edit registry/swift/cards/SwipeDeck.swift or SwipeDeck.mdx instead. */}
...
<Tabs items={["SwipeDeck.swift"]}>
<Tab value="SwipeDeck.swift">

```swift title="SwipeDeck.swift"
import SwiftUI
