...
{/* GENERATED FILE. Edit registry/swift/cards/FlipCard.swift or FlipCard.mdx instead. */}
...
<Tabs items={["FlipCard.swift"]}>
<Tab value="FlipCard.swift">

```swift title="FlipCard.swift"
import SwiftUI
