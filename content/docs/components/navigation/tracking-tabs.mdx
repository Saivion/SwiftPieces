...
{/* GENERATED FILE. Edit registry/swift/navigation/TrackingTabs.swift or TrackingTabs.mdx instead. */}
...
<Tabs items={["TrackingTabs.swift"]}>
<Tab value="TrackingTabs.swift">

```swift title="TrackingTabs.swift"
import SwiftUI
