...
{/* GENERATED FILE. Edit registry/swift/navigation/FloatingDock.swift or FloatingDock.mdx instead. */}
...
<Tabs items={["FloatingDock.swift"]}>
<Tab value="FloatingDock.swift">

```swift title="FloatingDock.swift"
import SwiftUI
