...
{/* GENERATED FILE. Edit registry/swift/media/PhotoViewer.swift or PhotoViewer.mdx instead. */}
...
<Tabs items={["PhotoViewer.swift"]}>
<Tab value="PhotoViewer.swift">

```swift title="PhotoViewer.swift"
import SwiftUI
