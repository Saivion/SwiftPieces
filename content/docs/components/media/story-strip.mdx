...
{/* GENERATED FILE. Edit registry/swift/media/StoryStrip.swift or StoryStrip.mdx instead. */}
...
<Tabs items={["StoryStrip.swift"]}>
<Tab value="StoryStrip.swift">

```swift title="StoryStrip.swift"
import SwiftUI
