...
{/* GENERATED FILE. Edit registry/swift/lists/StatusTimeline.swift or StatusTimeline.mdx instead. */}
...
<Tabs items={["StatusTimeline.swift"]}>
<Tab value="StatusTimeline.swift">

```swift title="StatusTimeline.swift"
import SwiftUI
import UIKit
