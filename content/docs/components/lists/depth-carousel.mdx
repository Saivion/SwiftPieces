...
{/* GENERATED FILE. Edit registry/swift/lists/DepthCarousel.swift or DepthCarousel.mdx instead. */}
...
<Tabs items={["DepthCarousel.swift"]}>
<Tab value="DepthCarousel.swift">

```swift title="DepthCarousel.swift"
import SwiftUI
import UIKit
