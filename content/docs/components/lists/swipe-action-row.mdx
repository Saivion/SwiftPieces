...
{/* GENERATED FILE. Edit registry/swift/lists/SwipeActionRow.swift or SwipeActionRow.mdx instead. */}
...
<Tabs items={["SwipeActionRow.swift"]}>
<Tab value="SwipeActionRow.swift">

```swift title="SwipeActionRow.swift"
import SwiftUI
import UIKit
