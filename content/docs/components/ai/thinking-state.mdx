...
{/* GENERATED FILE. Edit registry/swift/ai/ThinkingState.swift or ThinkingState.mdx instead. */}
...
<Tabs items={["ThinkingState.swift"]}>
<Tab value="ThinkingState.swift">

```swift title="ThinkingState.swift"
import SwiftUI
import UIKit
