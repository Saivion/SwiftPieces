...
{/* GENERATED FILE. Edit registry/swift/ai/PromptChips.swift or PromptChips.mdx instead. */}
...
<Tabs items={["PromptChips.swift"]}>
<Tab value="PromptChips.swift">

```swift title="PromptChips.swift"
import SwiftUI
import UIKit
