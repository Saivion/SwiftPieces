...
{/* GENERATED FILE. Edit registry/swift/inputs/SecureEntry.swift or SecureEntry.mdx instead. */}
...
<Tabs items={["SecureEntry.swift"]}>
<Tab value="SecureEntry.swift">

```swift title="SecureEntry.swift"
import SwiftUI
