...
{/* GENERATED FILE. Edit registry/swift/inputs/ScrubStepper.swift or ScrubStepper.mdx instead. */}
...
<Tabs items={["ScrubStepper.swift"]}>
<Tab value="ScrubStepper.swift">

```swift title="ScrubStepper.swift"
import SwiftUI
