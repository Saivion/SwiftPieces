...
{/* GENERATED FILE. Edit registry/swift/glass/GlassSurface.swift or GlassSurface.mdx instead. */}
...
<Tabs items={["GlassSurface.swift"]}>
<Tab value="GlassSurface.swift">

```swift title="GlassSurface.swift"
import SwiftUI
