...
{/* GENERATED FILE. Edit registry/swift/data/RingBreakdown.swift or RingBreakdown.mdx instead. */}
...
<Tabs items={["RingBreakdown.swift"]}>
<Tab value="RingBreakdown.swift">

```swift title="RingBreakdown.swift"
import SwiftUI
