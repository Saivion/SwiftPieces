...
{/* GENERATED FILE. Edit registry/swift/data/ScrubChart.swift or ScrubChart.mdx instead. */}
...
<Tabs items={["ScrubChart.swift"]}>
<Tab value="ScrubChart.swift">

```swift title="ScrubChart.swift"
import SwiftUI
import Charts
