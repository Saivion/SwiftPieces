...
{/* GENERATED FILE. Edit registry/swift/data/Odometer.swift or Odometer.mdx instead. */}
...
<Tabs items={["Odometer.swift"]}>
<Tab value="Odometer.swift">

```swift title="Odometer.swift"
import SwiftUI
