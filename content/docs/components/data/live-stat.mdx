...
{/* GENERATED FILE. Edit registry/swift/data/LiveStat.swift or LiveStat.mdx instead. */}
...
<Tabs items={["LiveStat.swift"]}>
<Tab value="LiveStat.swift">

```swift title="LiveStat.swift"
import SwiftUI
