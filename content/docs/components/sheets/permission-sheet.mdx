...
{/* GENERATED FILE. Edit registry/swift/sheets/PermissionSheet.swift or PermissionSheet.mdx instead. */}
...
<Tabs items={["PermissionSheet.swift"]}>
<Tab value="PermissionSheet.swift">

```swift title="PermissionSheet.swift"
import SwiftUI
