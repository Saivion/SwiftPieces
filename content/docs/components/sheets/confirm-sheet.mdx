...
{/* GENERATED FILE. Edit registry/swift/sheets/ConfirmSheet.swift or ConfirmSheet.mdx instead. */}
...
<Tabs items={["ConfirmSheet.swift"]}>
<Tab value="ConfirmSheet.swift">

```swift title="ConfirmSheet.swift"
import SwiftUI
