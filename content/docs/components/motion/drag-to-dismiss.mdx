...
{/* GENERATED FILE. Edit registry/swift/motion/DragToDismiss.swift or DragToDismiss.mdx instead. */}

Photos-style dismiss: drag in any direction, the view rounds and shrinks as it travels, the scrim thins, and a far enough drag or a fast flick sends it off screen along the direction it was moving.
...
<Tabs items={["DragToDismiss.swift"]}>
<Tab value="DragToDismiss.swift">

```swift title="DragToDismiss.swift"
import SwiftUI
