...
const map: Record<string, ComponentType> = {
  ...
  WeightWave: dynamic(() => import("./text").then((m) => m.WeightWavePreview)),
  Aurora: dynamic(() => import("./backgrounds").then((m) => m.AuroraPreview)),
  Silk: dynamic(() => import("./backgrounds").then((m) => m.SilkPreview)),
  Grain: dynamic(() => import("./backgrounds").then((m) => m.GrainPreview)),
  TouchGrid: dynamic(() => import("./backgrounds").then((m) => m.TouchGridPreview)),
  AmbientMesh: dynamic(() => import("./backgrounds").then((m) => m.AmbientMeshPreview)),
  ...
  PullToRefresh: dynamic(() => import("./lists").then((m) => m.PullToRefreshPreview)),
