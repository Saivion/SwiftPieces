      ...
      <Container className="relative">
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-[46rem]">
            <Reveal><Eyebrow>New components every week</Eyebrow></Reveal>
            <AnimatedText as="h1" text="Native SwiftUI that feels alive." accent="alive" className="p-hero mt-8" />
            <Reveal delay={0.35}><p className="p-body mt-7 max-w-xl text-[15px]">Designed SwiftUI interactions: swipe decks, glass menus, floating docks, scrubbable charts. One file each, iOS 17 and up, with the motion, haptics and states already done.</p></Reveal>       
