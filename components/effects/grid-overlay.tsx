...
export function GridOverlay({ columns = 12, className }: { columns?: number; className?: string }) {
  return (
    <div aria-hidden className={cn("pointer-events-none absolute inset-0 -z-10 mx-auto hidden w-full max-w-[var(--container)] px-5 sm:px-8 lg:block lg:px-12 2xl:px-16", className)}>
